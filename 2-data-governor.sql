...
-- Detach masking policies from tag before replacing (safe to ignore errors on first run — policies not yet attached)
ALTER TAG HRZN_DB.TAG_SCHEMA.DATA_CLASSIFICATION UNSET MASKING POLICY HRZN_DB.TAG_SCHEMA.DATA_CLASSIFICATION_MASK_STRING;
ALTER TAG HRZN_DB.TAG_SCHEMA.DATA_CLASSIFICATION UNSET MASKING POLICY HRZN_DB.TAG_SCHEMA.DATA_CLASSIFICATION_MASK_NUMBER;
ALTER TAG HRZN_DB.TAG_SCHEMA.DATA_CLASSIFICATION UNSET MASKING POLICY HRZN_DB.TAG_SCHEMA.DATA_CLASSIFICATION_MASK_DATE;
ALTER TAG HRZN_DB.TAG_SCHEMA.DATA_CLASSIFICATION UNSET MASKING POLICY HRZN_DB.TAG_SCHEMA.DATA_CLASSIFICATION_MASK_TIMESTAMP;
...
CASE
    WHEN CURRENT_ROLE() IN ('HRZN_DATA_ENGINEER', 'HRZN_DATA_GOVERNOR', 'ACCOUNTADMIN') THEN VAL
...
ALTER TABLE HRZN_DB.HRZN_SCH.CUSTOMER
    DROP ROW ACCESS POLICY IF EXISTS HRZN_DB.TAG_SCHEMA.CUSTOMER_OPTIN_POLICY;
ALTER TABLE HRZN_DB.HRZN_SCH.CUSTOMER
    DROP ROW ACCESS POLICY IF EXISTS HRZN_DB.TAG_SCHEMA.CUSTOMER_STATE_RESTRICTIONS;
ALTER TABLE HRZN_DB.HRZN_SCH.CUSTOMER
...
ALTER TABLE HRZN_DB.HRZN_SCH.CUSTOMER_ORDERS
    DROP ROW ACCESS POLICY IF EXISTS HRZN_DB.TAG_SCHEMA.CUSTOMER_ORDERS_STATE_RESTRICTIONS;
ALTER TABLE HRZN_DB.HRZN_SCH.CUSTOMER_ORDERS
