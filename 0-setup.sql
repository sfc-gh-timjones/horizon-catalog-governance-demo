...
GRANT ROLE HRZN_DATA_ENGINEER TO USER identifier(CURRENT_USER());
GRANT ROLE HRZN_DATA_GOVERNOR TO USER identifier(CURRENT_USER());
GRANT ROLE HRZN_DATA_USER TO USER identifier(CURRENT_USER());
GRANT ROLE HRZN_IT_ADMIN TO USER identifier(CURRENT_USER());
